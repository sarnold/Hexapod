 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Wed Jun 17 10:37:54 2015
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME BBB_ARBOTIX_READ_SERVO
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Input Port  1 */
#define IN_PORT_1_NAME      id
#define INPUT_1_WIDTH       18
...
/* Input Port  2 */
#define IN_PORT_2_NAME      nbrOfServo
...
/* Input Port  3 */
#define IN_PORT_3_NAME      nbrBytes
...
/* Output Port  1 */
#define OUT_PORT_1_NAME      dataOut
#define OUTPUT_1_WIDTH       18
...
extern void BBB_ARBOTIX_READ_SERVO_Outputs_wrapper(const uint8_T *portNbr,
			const uint8_T *id,
			...
			uint16_T *dataOut,
			const real_T *xD);
extern void BBB_ARBOTIX_READ_SERVO_Update_wrapper(const uint8_T *portNbr,
			const uint8_T *id,
			const uint8_T *nbrOfServo,
			const uint8_T *nbrBytes,
			const uint8_T *reg,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const uint8_T   *nbrOfServo  = (const uint8_T*) ssGetInputPortSignal(S,2);
    const uint8_T   *nbrBytes  = (const uint8_T*) ssGetInputPortSignal(S,3);
    const uint8_T   *reg  = (const uint8_T*) ssGetInputPortSignal(S,4);
    real_T        *debug  = (real_T *)ssGetOutputPortRealSignal(S,0);
    uint16_T        *dataOut  = (uint16_T *)ssGetOutputPortRealSignal(S,1);
    const real_T   *xD = ssGetDiscStates(S);


    BBB_ARBOTIX_READ_SERVO_Outputs_wrapper(portNbr, id, nbrOfServo, nbrBytes, reg, debug, dataOut, xD);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    BBB_ARBOTIX_READ_SERVO_Update_wrapper(portNbr, id, nbrOfServo, nbrBytes, reg, debug, dataOut,  xD);
}
