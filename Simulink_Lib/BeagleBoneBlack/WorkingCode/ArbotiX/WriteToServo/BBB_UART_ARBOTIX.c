 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Wed Jun 17 12:48:22 2015
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME BBB_UART_ARBOTIX
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Input Port  2 */
#define IN_PORT_2_NAME      nbrBytes
...
/* Output Port  1 */
#define OUT_PORT_1_NAME      data_out
#define OUTPUT_1_WIDTH       60
...
extern void BBB_UART_ARBOTIX_Outputs_wrapper(const uint8_T *portNbr,
			const uint8_T *data,
			const uint8_T *nbrBytes,
			real_T *debug,
			real_T *data_out,
			const real_T *xD);
extern void BBB_UART_ARBOTIX_Update_wrapper(const uint8_T *portNbr,
			const uint8_T *data,
			const uint8_T *nbrBytes,
			const real_T *debug,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    BBB_UART_ARBOTIX_Outputs_wrapper(portNbr, data, nbrBytes, debug, data_out, xD);
